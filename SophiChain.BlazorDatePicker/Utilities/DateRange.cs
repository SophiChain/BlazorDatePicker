...
{
    /// <summary>
    /// Represents a date range used by a date picker.
    /// </summary>
    public class DateRange : Range<DateTime?>, IEquatable<DateRange>
    {
        ...
        public string ToString(Utilities.Converters.Converter<DateTime?, string> converter)
        {
        ...
        public static bool TryParse(string? value, Utilities.Converters.Converter<DateTime?, string> converter, out DateRange? date)
        {
            date = null;
        ...
        /// <param name="date">The result of the parse.</param>
        /// <returns><c>true</c> if the string was successfully interpreted as a date.</returns>
        public static bool TryParse(string start, string end, Utilities.Converters.Converter<DateTime?, string> converter, out DateRange? date)
        {
            date = null;
